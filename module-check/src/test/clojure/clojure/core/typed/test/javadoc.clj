...
(deftest add-remote-javadoc-test
  (is-tc-e (add-remote-javadoc "org.apache.commons.csv." "http://commons.apache.org/proper/commons-csv/apidocs/index.html") (Map Any Any)
  ...
  (is-tc-err (add-remote-javadoc "org.apache.commons.csv." "http://commons.apache.org/proper/commons-csv/apidocs/index.html") String
             :requires [[clojure.java.javadoc :refer [add-remote-javadoc]]]) 
  (is-tc-err (add-remote-javadoc 1 "http://commons.apache.org/proper/commons-csv/apidocs/index.html") (Map Any Any)
             :requires [[clojure.java.javadoc :refer [add-remote-javadoc]]]))
