...
(declare Exp2 Exp3 Prop Tpe Exp Exp4 Prop2)
(t/defalias Exp2
 (t/U
  '{:E ':var
    :name t/Sym}
  '{:E ':app
    :args (t/Vec Exp2), :fun Exp2}))
(t/defalias Exp3
 (t/U
  '{:args (t/Vec Exp3), :fun Exp3, :E ':app}
  '{:name t/Sym, :E ':var}))
(t/defalias Prop
 (t/U
  '{:P ':is,
  ...
  '{:P ':not, :p Prop}
  '{:P (t/U ':or ':and), :ps (t/Set Prop)}
  '{:P ':=, :exps (t/Set Exp3)}))
(t/defalias Tpe
 (t/U
  '{:return Tpe, :params (t/Vec '{:name t/Sym, :type Tpe}), :T ':fun}
  '{:T ':num}
...
(t/defalias Exp4
 (t/U
  '{:name t/Sym, :E ':var}
  '{:args (t/Vec Exp4), :fun Exp4, :E ':app}))
(t/defalias Prop2
 (t/U
  '{:P ':=, :exps (t/Set Exp4)}
  '{:P (t/U ':or ':and), :ps (t/Set Prop2)}
  '{:exp Exp4,
    :P ':is,
    :type '{:T ':intersection, :types (t/Set t/Nothing)}}
  '{:P ':not, :p Prop2}))
...
(t/ann
  ...
  [(t/U
     (t/HMap
       ...
       {:T ':false}
       :optional
       {:types (t/Set t/Nothing)})
     '{:T ':intersection, :types (t/Set t/Nothing)})
   :->
   (t/U t/Sym false)])
(t/ann parse-exp-test AnyFunction)
(t/ann parse-roundtrip [(t/Seqable t/Any) :-> Boolean])
(t/ann parse-prop [(t/Seqable t/Any) :-> P__472083])
(t/ann id [(t/Map t/Any t/Any) :-> (t/Map t/Any t/Any)])
(t/ann tc-test AnyFunction)
(t/ann id-test AnyFunction)
(t/ann check [(t/Set t/Nothing) '{:E ':false} :-> '{:T ':false}])
(t/ann parse-type [t/Any :-> alias__474772])
(t/ann unparse-exp [E__475238 :-> t/Any])
