...
(deftest transient-collection-test
  (is-tc-e (transient []) (Unique (clojure.lang.ITransientVector Any)))
  (is-tc-e (transient [1 2 3]) (Unique (clojure.lang.ITransientVector Number)))
  (is-tc-e (transient #{}) (Unique (clojure.lang.ITransientSet Any)))
  (is-tc-e (transient #{1 2}) (Unique (clojure.lang.ITransientSet Number)))
  (is-tc-e (transient {}) (Unique (clojure.lang.ITransientMap Any Any)))
  ;(is-tc-e (transient (sorted-set 4 3 1 2)) (clojure.lang.ITransientSet Number))
  (is-tc-e (transient (hash-set 1 2 1 2)) (Unique (clojure.lang.ITransientSet Number)))
  (is-tc-e (transient {:a "a" :b "b" :c "c"}) (Unique (clojure.lang.ITransientMap Keyword String)))
  (is-tc-e (transient {1 "a" 2 "b"}) (Unique (clojure.lang.ATransientMap Number String))))

(deftest assoc!-test
  (is-tc-e (assoc! (transient {}) :a 1) (Unique (clojure.lang.ITransientMap Keyword Number)))
  (is-tc-e (assoc! (transient {"a" 1}) "b" 2) (Unique (clojure.lang.ITransientMap String Number)))
  (is-tc-e (assoc! (transient [1 2 3]) 0 10) (Unique (clojure.lang.ITransientVector Number)))
  (is-tc-err (assoc! (transient [1 2 3] 4 10)) (Unique (clojure.lang.ITransientVector Number))))

(deftest dissoc!-test
  (is-tc-e (dissoc! (transient {}) :a) (Unique (clojure.lang.ITransientMap Any Any)))
  (is-tc-e (dissoc! (transient {:a 1 :b 2}) :a) (Unique (clojure.lang.ITransientMap Keyword Number))))

(deftest disj!-test
  (is-tc-e (disj! (transient #{'a 'b 'c}) 'c) (Unique (clojure.lang.ITransientSet Symbol)))
  (is-tc-e (disj! (transient #{1 2 3}) 3) (Unique (clojure.lang.ITransientSet Number))))
...
(deftest conj!-test
  (is-tc-e (conj! (transient [1 2 3]) 4) (Unique (clojure.lang.ITransientVector Number)))
  (is-tc-e (conj! (transient {1 2 3 4}) [5 6]) (Unique (clojure.lang.ITransientMap Number Number)))
  (is-tc-e (conj! (transient #{1 2 3}) 4) (Unique (clojure.lang.ITransientSet Number))))

(deftest pop!-test
  (is-tc-e (pop! (transient [1 2 3])) (Unique (clojure.lang.ITransientVector Number))))
