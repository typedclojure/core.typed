(ns clojure.core.typed.compiler-ast
  "Converts clojure.core.typed.Compiler to tools.analyzer AST format
...
(import '(clojure.core.typed Compiler))
...
(extend-protocol AnalysisToMap
  ...
  ;; a ConstantExpr is originally a quote if quote? is true
